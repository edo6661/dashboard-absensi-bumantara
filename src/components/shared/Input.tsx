...
const Input = ({ label, error, ...props }: InputProps) => {
  return (
    <div className="flex flex-col gap-1.5 mb-4 group w-full">
      ...
      <input
        className={`w-full px-4 py-3.5 text-sm rounded-xl border transition-all duration-300 outline-none placeholder:text-zinc-400 disabled:bg-zinc-50 disabled:text-zinc-400 disabled:cursor-not-allowed disabled:border-zinc-200
          ${error
